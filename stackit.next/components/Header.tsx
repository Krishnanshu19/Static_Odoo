              ...
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="hidden sm:flex items-center space-x-2 p-2">
                      {user?.avatar ? (
                        <img
                          src={user.avatar}
                          alt={user.username}
                      ...
                      <span className="hidden lg:block text-gray-300">{user?.username}</span>
                    </Button>
                  </DropdownMenuTrigger>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-700 py-4 space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {['Newest', 'Unanswered', 'Popular', 'Hot', 'Week', 'Month'].map((filter) => (
                <Button
                  key={filter}
                  variant="outline"
                  size="sm"
